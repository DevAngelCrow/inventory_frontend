    ...
    >
      ...
      >
        <AppInputText
          ...
          @keydown.enter="debouncedFindMeasurementUnit"
        />
        <AppSelect
        ...
        <Button
          ...
          @click="debouncedFindMeasurementUnit"
          >Buscar</Button
        >
        <Button
          class="shrink-0 grow md:grow-0 rounded-md"
...
import { MeasurementUnitResponse } from '../interfaces/inventory.interfaces';
import MeasurementUnitFormModal from '../components/MeasurementUnitFormModal.vue';

const measurementUnitInstance = useMeasurementUnit();
provide('useMeasurementUnit', measurementUnitInstance);
...
const openModal = (
  ...
  switch (action) {
    case 'add':
      modalState.title = 'Agregar Unidad de Medida';
      break;
    case 'view':
      modalState.title = 'Ver Unidad de Medida';
      setMeasurementUnitItem(data!);
      break;
    case 'edit':
      modalState.title = 'Editar Unidad de Medida';
      setMeasurementUnitItem(data!);
      break;
    case 'delete':
      setMeasurementUnitItem(data!);
      modalState.title = data!.active ? 'Desactivar Unidad' : 'Activar Unidad';
      modalState.description = `¿Está seguro de cambiar el estado de la unidad a ${data!.active ? 'inactivo' : 'activo'}?`;
