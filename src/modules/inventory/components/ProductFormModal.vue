<template>
  ...
  >
    ...
    >
      ...
      <div
        class="w-full min-w-0 md:col-span-2 flex flex-col gap-2 justify-center items-center"
      >
...
import AppProductDimensions from './products/AppProductDimensions.vue';
