          ...
          <template #content>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
              <AppSelect
                ...
                label="Cliente*"
                v-model="id_customer"
                :error-messages="errors.id_customer"
                v-bind="idCustomerAttrs"
              ...
              >
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <AppSelect
                    ...
                    label="Rellenar con dirección guardada del cliente"
                    v-model="id_customer_address"
                    :error-messages="errors.id_customer_address"
                    v-bind="idCustomerAddressAttrs"
                  ...
                  <AppInputText
                    ...
                    v-model="delivery_address_line2"
                    :error-messages="errors.delivery_address_line2"
                    v-bind="deliveryAddressLine2Attrs"
                    :readonly="isReadonly"
                  />

                  <AppGeographicCascade
                    class="w-full"
                    id="id_geographic_division"
                    v-model="id_geographic_division"
                    :error-messages="errors.id_geographic_division"
                    :id_country="selectedCustomerCountryId"
                    :readonly="isReadonly"
                  />
                  <AppInputText
                    class="w-full"
                    ...
                    :error-messages="errors.delivery_zip"
                    v-bind="deliveryZipAttrs"
                    :readonly="isReadonly"
                  />
                  ...
                  <AppInputextArea
                    ...
                    :error-messages="errors.delivery_notes"
                    v-bind="deliveryNotesAttrs"
                    :readonly="isReadonly"
                  />
                </div>
              </div>
              ...
              <AppDatePicker
                ...
                v-model="event_start"
                :error-messages="errors.event_start"
                v-bind="eventStartAttrs"
                showTime
                :readonly="isReadonly"
              />
              ...
              <AppDatePicker
                ...
                v-model="event_end"
                :error-messages="errors.event_end"
                v-bind="eventEndAttrs"
                showTime
                :readonly="isReadonly"
              />
            </div>
            ...
            <template #content>
              <div class="flex flex-col gap-4">
                ...
                <AppInputMoney
                  ...
                  :error-messages="errors.delivery_fee"
                  v-bind="deliveryFeeAttrs"
                  :readonly="isReadonly"
                />
                ...
                <AppInputMoney
                  ...
                  v-bind="discountAmountAttrs"
                  :readonly="isReadonly"
                />

                <div
                  class="flex justify-between border-b pb-2 text-lg font-bold"
                >
                ...
                <AppInputMoney
                  class="w-full"
                  id="deposit_amount"
                  label="Anticipo / Depósito Pagado"
                  v-model="deposit_amount"
                  :error-messages="errors.deposit_amount"
                  v-bind="depositAmountAttrs"
                  :readonly="isReadonly"
                />

                <div
                  class="flex justify-between text-lg font-bold text-red-600"
                >
...
const computedStatusLabel = computed(() => {
  ...
  const baseStatus = status.value as
    | { code: string; name: string; state_color: string }
    | undefined;
